 ...
 * {@link SubmitFragment.OnSubmitActionListener} interface
...
public class SubmitFragment extends Fragment {
    ...
    private OnSubmitActionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RadioGroup radioGroup = (RadioGroup) getActivity().findViewById(R.id.university);
                int selectedRadioButtonId = radioGroup.getCheckedRadioButtonId();

                if (selectedRadioButtonId != -1){
                    RadioButton selectedRadioButton = (RadioButton) getActivity().findViewById(selectedRadioButtonId);
                    String university = selectedRadioButton.getText().toString();
                    mUserData.setUniversity(university);
                }

                mListener.onSubmitAction(mUserData);
            }
        });
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnSubmitActionListener) activity;
